<?php if (!defined('BASEPATH')) exit('No direct script access allowed');
    ...
    class type extends CI_Controller {
        ...
        public function index() {
            if ($this->input->post('submit')) {
                ...
                if ($this->form_validation->run() == False) {
                    ...
                    $typ_id = $this->type_model->create_type($form_data);
                    if (!$typ_id) {
                        die("ERROR");
                    }
                    redirect('/type/view/'.$typ_id);
                }
            }
            try {
                $this->load->helper('form');
                $this->load->model('type_model');  
                $this->load->view('add_new_type',$this->data);
            }
            catch( Exception $e) {
        ...
        public function view_all() {
            $this->load->model('type_model'); 
            $types = $this->type_model->getall_type();  
            ...
            $this->load->view('type_all_view', $this->data);
        }

        public function view($typ_id) {
            //die(print_r($iss_id));
            $this->load->model('type_model'); 
            $type = $this->type_model->get_type($typ_id);
            $this->data['type'] = array();
            $this->data['type']['id'] = $this->translate($type['id']);
            $this->data['type']['type'] = $type['type'];
            ...
            $this->load->view('type_view', $this->data);
        }
