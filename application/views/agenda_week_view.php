                        ...
                        <h1>&nbsp &nbsp &nbsp &nbsp &nbsp</h1>
                                ...
                                <div class="portlet light bordered">
                                    <div class="portlet-title">
                                        ...
                                        <br class="non-printable">
                                        <div class="centered">
                                          <h2>الاجندة الاسبوعية </h2>
                                          <h3 style="margin-right: -0px;">بتاريخ من&nbsp<?php echo $start ?>&nbsp<?php echo $date ?>&nbspإلى&nbsp<?php echo $end ?>&nbsp<?php echo $date1 ?></h3>
                                          <a href="/agenda" class="btn btn-danger non-printable" style="float:right;">الاجندة اليومية</a>
