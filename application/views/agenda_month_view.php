                        ...
                        <h1>&nbsp &nbsp &nbsp &nbsp &nbsp</h1>
                                ...
                                <div class="portlet light bordered">
                                    <div class="portlet-title">
                                        ...
                                        <br class="non-printable">
                                        <div class="centered">
                                          <h2>الاجندة الشهرية لشهر <?php echo $month ?></h2>
                                          <h3 style="margin-right: -0px;">بتاريخ من&nbsp<?php echo $date ?> إلى&nbsp<?php echo $date1 ?></h3>
                                          <a href="/agenda" class="btn btn-danger non-printable" style="float:right;">الاجندة اليومية</a>
                                          <a href="/agenda/week" class="btn btn-danger non-printable" style="float:right; margin-right: 10px;">الاجندة الاسبوعية</a>
                                        </div>
