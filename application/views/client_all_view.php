...
<html lang="en" dir="rtl">
    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo">
                                    ...
                                    <div class="pager tablesorter-pager non-printable">
                                        ...
                                        <table class="table table-bordered table-hover table-striped tablesorter hanys">
                                            <thead class="non-printable">
                                                <tr>
                                                    <th class="header centered">كود الموكل<i class="fa fa-sort"></i></th>
                                                    <th class="header centered">اسم الموكل<i class="fa fa-sort"></i></th>
                                                    <th class="header centered non-printable">عرض<i class="fa fa-sort"></i></th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <?php foreach($clients as $client ){?>
                                                    <?php if ($client['name'] != NULL){?>
                                                        <tr class="active">
                                                            <td class="centered"> &nbsp &nbsp <?php echo $client['id'] ?></td>
                                                            <td class="centered"> &nbsp &nbsp <?php echo $client['name'] ?></td>
                                                            <td class="centered non-printable">
                                                                <a href="/client/view/<?php echo $client['ids'] ?> " class="btn btn-primary">عرض الموكل</a>
                                                            </td>
                                                        </tr>
                                                    <?php } ?>
                                                <?php } ?>
      ...
      $(function(){
        ...
        .find(".tablesorter-filter-row td:last input").replaceWith('<a href="<?php echo base_url(); ?>client/view_all" class="reset-filters btn btn-warning non-printable">Reset</a>');
      });
    </script>
    </body>
</html>
