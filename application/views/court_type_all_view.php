...
<html lang="en" dir="rtl">
    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo">
                                    ...
                                    <div class="pager tablesorter-pager non-printable">
                                        ...
                                        <table class="table table-bordered table-hover table-striped tablesorter hanys">
                                            <thead class="non-printable">
                                                <tr>
                                                    <th class="header centered">كود المحكمة<i class="fa fa-sort"></i></th>
                                                    <th class="header centered">اسم المحكمة<i class="fa fa-sort"></i></th>
                                                    <th class="header centered non-printable">عرض<i class="fa fa-sort"></i></th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <?php foreach($courts as $court ){?>
                                                    <?php if ($court['name'] != NULL){?>
                                                        <tr class="active">
                                                            <td class="centered"> &nbsp &nbsp <?php echo $court['id'] ?></td>
                                                            <td class="centered"> &nbsp &nbsp <?php echo $court['name'] ?></td>
                                                            <td class="centered non-printable">
                                                                <a href="/court/view/<?php echo $court['ids'] ?> " class="btn btn-primary">عرض المحكمة</a>
                                                            </td>
                                                        </tr>
                                                    <?php } ?>
                                                <?php } ?>
      ...
      $(function(){
        ...
        .find(".tablesorter-filter-row td:last input").replaceWith('<a href="<?php echo base_url(); ?>court/view_all" class="reset-filters btn btn-warning non-printable">Reset</a>');
      });
    </script>
    </body>
</html>
