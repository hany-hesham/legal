...
<html lang="en" dir="rtl">
    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo">
                        ...
                        <div class="page-content hany">
                                ...
                                <div class="portlet light bordered">
                                    <div class="portlet-title">
                                        ...
                                        <br class="non-printable">
                                        <div class="centered">
                                <h1>عرض جميع المنشورات الإدارية</h1>
                            </div>
                                    <div class="pager tablesorter-pager non-printable">
                                        ...
                                        <table class="table table-bordered table-hover table-striped tablesorter hanys">
                                            <thead class="non-printable">
                                                <tr>
                                                    <th class="header centered">كود المنشور<i class="fa fa-sort"></i></th>
                                                    <th class="header centered">موضوع المنشور<i class="fa fa-sort"></i></th>
                                                    <th class="header centered">تاريخ الإجتماع<i class="fa fa-sort"></i></th>
                                                    <th class="header centered non-printable">عرض<i class="fa fa-sort"></i></th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <?php foreach($managements as $management ){?>
                                                    <?php if ($management['subject'] != NULL){?>
                                                        <tr class="active">
                                                            <td class="centered"> &nbsp &nbsp <?php echo $management['id'] ?></td>
                                                            <td class="centered"> &nbsp &nbsp <?php echo $management['subject'] ?></td>
                                                            <td class="centered"> &nbsp &nbsp <?php echo $management['date'] ?></td>
                                                            <td class="centered non-printable">
                                                                <a href="/management/view/<?php echo $management['ids'] ?> " class="btn btn-primary">عرض المنشور</a>
                                                            </td>
                                                        </tr>
                                                    <?php } ?>
                                                <?php } ?>
      ...
      $(function(){
        ...
        .find(".tablesorter-filter-row td:last input").replaceWith('<a href="<?php echo base_url(); ?>management/view_all" class="reset-filters btn btn-warning non-printable">Reset</a>');
      });
    </script>
    </body>
</html>
