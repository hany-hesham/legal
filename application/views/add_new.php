            ...
            <div class="portlet light bordered">
              <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="page-header">
                  ...
                  <h1 class="centered"> إضافة قضية </h1>
                </div>
                ...
                <form role="form" method="POST" id="form-submit" enctype="multipart/form-data" class="form-div span12" accept-charset="utf-8">
                  <div class="form-body">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="opponent" class="form-control input-circle" style="width: 40%;"/>
                    </div>
                    <div class="form-group">
                      <label style="font-size: 18px; font-weight: bold;"> عنوان الخصم </label>
                      <input type="text" name="opnt_address" class="form-control input-circle" style="width: 40%;"/>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <textarea type="text" name="describtion" class="form-control" rows="3"></textarea>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <script>
                        $("#offers").fileinput({
                          uploadUrl: "/issue/make_offer/<?php echo $assumed_id; ?>", // server upload action
                          uploadAsync: true,
                          minFileCount: 1,
                          maxFileCount: 5,
                          ...
                          initialPreviewConfig: [
                            <?php foreach($uploads as $upload): ?>
                                {url: "/issue/remove_offer/<?php echo $assumed_id ?>/<?php echo $upload['id'] ?>", key: "<?php echo $upload['name']; ?>"},
                            <?php endforeach; ?>
                          ],
                        });
                      </script>
