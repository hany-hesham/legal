...
<html lang="en" dir="rtl">
    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo">
                                    ...
                                    <div class="pager tablesorter-pager non-printable">
                                        ...
                                        <table class="table table-bordered table-hover table-striped tablesorter hanys">
                                            <thead class="non-printable">
                                                <tr>
                                                    <th class="header centered">رقم الفندق<i class="fa fa-sort"></i></th>
                                                    <th class="header centered">اسم الفندق<i class="fa fa-sort"></i></th>
                                                    <th class="header centered">كود الفندق<i class="fa fa-sort"></i></th>
                                                    <th class="header centered non-printable">عرض<i class="fa fa-sort"></i></th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <?php foreach($hotels as $hotel ){?>
                                                    <?php if ($hotel['name'] != NULL){?>
                                                        <tr class="active">
                                                            <td class="centered"> &nbsp &nbsp <?php echo $hotel['id'] ?></td>
                                                            <td class="centered"> &nbsp &nbsp <?php echo $hotel['name'] ?></td>
                                                            <td class="centered"> &nbsp &nbsp <?php echo $hotel['code'] ?></td>
                                                            <td class="centered non-printable">
                                                                <a href="/hotel/view/<?php echo $hotel['ids'] ?> " class="btn btn-primary">عرض الفندق</a>
                                                            </td>
                                                        </tr>
                                                    <?php } ?>
                                                <?php } ?>
      ...
      $(function(){
        ...
        .find(".tablesorter-filter-row td:last input").replaceWith('<a href="<?php echo base_url(); ?>opponent/view_all" class="reset-filters btn btn-warning non-printable">Reset</a>');
      });
    </script>
    </body>
</html>
