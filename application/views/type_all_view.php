...
<html lang="en" dir="rtl">
    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo">
                                    ...
                                    <div class="pager tablesorter-pager non-printable">
                                        ...
                                        <table class="table table-bordered table-hover table-striped tablesorter hanys">
                                            <thead class="non-printable">
                                                <tr>
                                                    <th class="header centered">كود الصفة<i class="fa fa-sort"></i></th>
                                                    <th class="header centered">الصفة<i class="fa fa-sort"></i></th>
                                                    ...
                                                    <?php if ($type['type'] != NULL){?>
                                                        <tr class="active">
                                                            ...
                                                            <td class="centered non-printable">
                                                                <a href="/type/view/<?php echo $type['ids'] ?> " class="btn btn-primary">عرض الصفة</a>
                                                            </td>
                                                        </tr>
                                                    <?php } ?>
                                                <?php } ?>
      ...
      $(function(){
        ...
        .find(".tablesorter-filter-row td:last input").replaceWith('<a href="<?php echo base_url(); ?>type/view_all" class="reset-filters btn btn-warning non-printable">Reset</a>');
      });
    </script>
    </body>
</html>
