            ...
            <div class="portlet light bordered">
              <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="page-header">
                  ...
                  <h1 class="centered"> إضافة موكل </h1>
                </div>
              ...
              <div class="portlet-body form">
                <form role="form" method="POST" id="form-submit" enctype="multipart/form-data" class="form-div span12" accept-charset="utf-8">
                  <div class="form-body">
                    ...
                    <div class="form-group">
                      <label style="font-size: 18px; font-weight: bold;"> العنوان </label>
                      <input type="text" name="address" class="form-control input-circle" style="width: 40%;"/>
                    </div>
                  </div>
