...
<html lang="en" dir="rtl">
    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo">
                            ...
                            <div class="col-md-12">
                                <div class="portlet light bordered">
                                    <div class="portlet-title">
                                        ...
                                        <br class="non-printable">
                                        <div class="centered">
                                            <h2>الاجندة اليومية </h2>
                                            <h3 style="margin-right: -0px;"><?php echo $da; ?> &nbsp <?php echo $das; ?></h3>
                                            <a href="/agenda/week" class="btn btn-danger non-printable" style="float:right;">الاجندة الاسبوعية</a>
                                            <a href="/agenda/month" class="btn btn-danger non-printable" style="float:right; margin-right: 10px;">الاجندة الشهرية</a>
                                        </div>
                                            ...
                                            <tbody>
                                                <?php foreach($issues as $issue ){?>
                                                    <?php if ($issue['number'] != NULL){?>
                                                        <tr class="active">
                                                            <td class="centered"> <?php echo $issue['hotel_name'] ?></td>
                                                            <td class="centered"> 
      ...
      $(function(){
        ...
        .find(".tablesorter-filter-row td:last input").replaceWith('<a href="<?php echo base_url(); ?>agenda" class="reset-filters btn btn-warning non-printable">Reset</a>');
      });
    </script>
    </body>
</html>
