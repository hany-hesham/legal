            ...
            <div class="portlet light bordered">
              <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="page-header">
                  ...
                  <h1 class="centered"> إضافة فندق </h1>
                </div>
                ...
                <form role="form" method="POST" id="form-submit" enctype="multipart/form-data" class="form-div span12" accept-charset="utf-8">
                  <div class="form-body">
                    <div class="form-group">
                      ...
                      <input type="text" name="name" class="form-control input-circle" style="width: 40%;"/>
                    </div>
                    <div class="form-group">
                      <label style="font-size: 18px; font-weight: bold;"> اختصار </label>
                      <input type="text" name="code" class="form-control input-circle" style="width: 40%;"/>
                    </div>
                    <div class="form-group">
                      <label style="font-size: 18px; font-weight: bold;"> شعار الفندق </label>
                      <input type="file" name="logo" class="form-control input-circle" style="width: 40%;"/>
                    </div>
                  </div>
